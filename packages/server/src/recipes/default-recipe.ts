...
export const defaultFechamentoRecipe = defineRecipe<FechamentoVendedorRow>({
  id: "fechamento_mes",
  ...
  // Datas (start_date / end_date) são universais e obrigatórias em toda Área de Trabalho,
  // não sendo declaradas como parâmetros adicionais do Modelo.
  workspace: {
    params: [
      {
...
export default defaultFechamentoRecipe;
